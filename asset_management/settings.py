...
Sistem Inventori Laptop Lelang - PROTELINDO
"""
...
SECRET_KEY = 'django-insecure-nc$c3=e)d_d#zp7^)bu*tjm78x$#ul$-+f2a_l9jz9hxfn$@u%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Mengizinkan akses dari semua host/IP
